...
public class CreateTablesLoadData {
	...
	static AmazonDynamoDB client = AmazonDynamoDBClientBuilder.standard().
									withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("http://localhost:8000", "sa-east-"))
									.withCredentials(new AWSStaticCredentialsProvider(new BasicAWSCredentials("1", "dev2020")))
									.build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            createTable("Pessoa", 10L,5L,"pessoaId","N");
            loadSamplePessoa("Pessoa");
    ...
    private static void loadSamplePessoa(String tableName) {
        ...
        try {
           ...
           /* Item item = new Item().withPrimaryKey("Name", "Amazon DynamoDB")
            ...
            Item item = new Item().withPrimaryKey("pessoaId", 1)
            		.withJSON("Pessoa", json);
            table.putItem(item);
